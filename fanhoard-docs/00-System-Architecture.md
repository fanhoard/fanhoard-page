...
> เอกสารนี้อธิบายภาพรวมสถาปัตยกรรมของโปรเจกต์ **FanHoard** (หรือชื่อเต็ม **FanHoard Verse`) — แพลตฟอร์มคลังอีโมจิ สัญลักษณ์ ข้อความแฟนซี และคอลเลกชันอื่น ๆ ที่ทำงานเป็น static website บน Cloudflare Pages
>
...
**FanHoard** (หรือชื่อเต็ม **FanHoard Verse`) เป็นแพลตฟอร์มคลังอีโมจิ สัญลักษณ์ (symbol) ข้อความแฟนซี (fancy text) และคอลเลกชันอื่น ๆ ที่ทำงานเป็น static website บน **Cloudflare Pages** ที่ URL `fanhoard.pages.dev`
...
│
├── fanhoard-docs/                      # 📚 All documentation (this folder)
...
├── LICENSE                             # Apache 2.0
├── NOTICE                              # Attribution
└── README.md                           # Repo entry — links to fanhoard-docs/INDEX.md
```
...
```
https://fanhoard.pages.dev/{lang}/{page-path}
```
...
SEO เป็น priority ระดับพิเศษที่สูงเป็นอันดับ 2 ของ FanHoard (รองจาก Documentation) — ทุกการตัดสินใจทางเทคนิคต้องคำนึงถึงผลกระทบต่อ search engine visibility ดูรายละเอียดเต็มใน [`12-SEO-Guide.md`](./12-SEO-Guide.md)
...
เอกสารเป็น priority สูงสุดของ FanHoard — สูงกว่า SEO และ Performance เพราะเป็นตัวอธิบายระบบและทำให้การพัฒนาเป็นไปได้อย่างราบรื่น ถ้าเอกสารไม่ตรงจริง ทุกคน (รวมถึง AI) จะสับสน
...
- ชื่อ: ใช้ "FanHoard" ไม่ใช่ "FanHoard" หรือ "FanHoard Page"
